...
Основой библиотеки является событие - сообщение от телеграма с данными о том кто написал боту и что написал. Библиотека парсит событие и на основе построенной разработчиком структуры бота выполняет те или иные действия. Далее будет предложено описание методов с примерами их использования. 
...
- [Ожидание события от пользователя - bind_input()](#bind_input)
- [Скачивание файлов - download_file()](#download_file)
...
### Ожидание события от пользователя - bind_input() <a name="bind_input"></a>
...
### Скачивание файлов - download_file() <a name="download_file"></a>
